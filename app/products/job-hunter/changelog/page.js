...
export const metadata = {
  title: 'Job Hunter — Changelog | TechM8',
  description: 'Release notes and version history for Job Hunter, the local-first AI job-hunting agent.',
};

export default function JobHunterChangelogPage() {
  return (
    <div className="bg-gradient-to-br from-slate-900 via-violet-950 to-slate-900 min-h-screen">
      <section className="relative overflow-hidden py-20 md:py-24">
        ...
        <div className="relative max-w-3xl mx-auto px-6">
          <Link href="/products/job-hunter" className="inline-flex items-center gap-1 text-violet-300 hover:text-violet-200 text-sm mb-8">
          ...
          <p className="text-gray-400 text-sm md:text-base mb-12">Every release of Job Hunter, newest first.</p>
