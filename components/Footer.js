export default function Footer() {
  return (
    <footer className="relative bg-slate-900 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-32 bg-violet-500/10 blur-3xl rounded-full" />
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-14">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 flex justify-start lg:justify-end">
            <div>
              <h4 className="text-xs font-semibold text-violet-400 uppercase tracking-widest mb-5">Contact</h4>
              <ul className="space-y-4">
                <li>
                  <a href="mailto:masnun@tech-m8.solutions" className="flex items-start gap-3 text-gray-400 text-sm hover:text-white transition-colors group">
                    <div className="w-8 h-8 rounded-lg bg-violet-500/10 border border-violet-500/20 flex items-center justify-center flex-shrink-0 group-hover:border-violet-400/50 transition-colors">
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-gray-500 text-xs">
          ...
          <span className="text-violet-500/50">tech-m8.solutions</span>
        </div>
      </div>
    </footer>
  );
