...
export const changelog = [
  {
    ...
    date: '2026-07-16',
    changes: [
      'macOS installer is now built on the cross-platform Tauri stack — the same one-line command delivers a native .app bundle (mounted from a `.dmg`) straight to your Applications folder.',
    ],
  },
  {
    version: 'v0.1.8',
    date: '2026-07-01',
    changes: [
      'Native macOS app polish: the license banner no longer overlaps the pane title, and every pane sits flush under its header for a cleaner, consistent look.',
      'Fixed the Settings → Crawl section so its controls align left like the other tabs.',
    ],
  },
  {
    version: 'v0.1.7',
